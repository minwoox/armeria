...
class DefaultAttributeMapTest {
    ...
    void testIterator() {
        ...
        final AttributeKey<Integer> key = AttributeKey.valueOf(
                com.linecorp.armeria.internal.DefaultAttributeMap.class, "KEY");
        map.setAttr(key, 42);
    ...
    void testIteratorWithFullMap() {
        ...
        assertThat(expectedKeys).isEqualTo(actualKeys());
...
//        final com.linecorp.armeria.internal.DefaultAttributeMap
//                root = new com.linecorp.armeria.internal.DefaultAttributeMap(null);
//        final com.linecorp.armeria.internal.DefaultAttributeMap
//                child = new com.linecorp.armeria.internal.DefaultAttributeMap(root);
//
